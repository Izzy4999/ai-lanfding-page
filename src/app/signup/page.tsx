        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium"
              ...
              <span>⭐</span>
              <span>Join <strong>50,000+</strong> people who landed their dream job</span>
            </div>
          </div>
          ...
          <div className="rounded-3xl p-10" style={{ background: "#fff", border: "1px solid #E5E7EB", boxShadow: "0 8px 40px rgba(0,0,0,0.06)" }}>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  style={{ border: "1.5px solid #E5E7EB", background: "#FAFAFA", color: "#0D0D14", fontSize: 15 }}
            ...
            <div className="relative my-6">
              ...
              <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 px-3 text-xs font-medium" style={{ background: "#fff", color: "#9CA3AF" }}>or sign up with</span>
            </div>
            ...
            <p className="text-center text-sm mt-6" style={{ color: "#6B7280" }}>
              ...
              <a href="/signin" className="font-semibold no-underline" style={{ color: "#0D0D14" }}>Sign in</a>
            </p>

            <p className="text-center text-xs mt-4" style={{ color: "#9CA3AF" }}>
              By creating an account, you agree to our{" "}
              <a href="#" className="no-underline underline-offset-2" style={{ color: "#6B7280" }}>Terms</a>{" "}
              and{" "}
              <a href="#" className="no-underline underline-offset-2" style={{ color: "#6B7280" }}>Privacy Policy</a>.
            </p>
          </div>
        </div>
      </div>
